...
import ConsultationsTable from "./components/Patients/ConsultationsTable";
...
Vue.component('consultations-table', ConsultationsTable);
Vue.component('consultation-table', ConsultationTable);
Vue.component('insurance-table', InsuranceTable);
