...
<style>
    ...
    .table{
        font-size: 13px;
        font:13px  "Google Sans", Roboto, arial, sans-serif;
...
<body>
    ...
    <div class="container1">
        ...
        <div id="footer">
            DR:  {{ $details->name }}  <br>                                                                                                       
            Signature: <img style="width: 90px" height="40px" src="{{ storage_path('app/public/img/signature/clinicPlus-logo.png')  }}">
        </div>
            {{--  Footer image  --}}
        <div id="footer-img">
